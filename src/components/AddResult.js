...
export default class AddResult extends Component {
    ...
    for (let i = 0; i < this.state.numDropdowns; ++i) {
      list.push(
        <Dropdown
          ...
          onChange={this.logSelectedData.bind(this)}
        />
      );
    }
    return list;
  ...
  getResult() {
    ...
    return `${gameData.winner} won the game ${
      ...
      <div>
        ...
        <div className="data-input">
          <Dropdown
            ...
            search
            selection
            options={this.state.leaderboards}
            onChange={this.getPlayers.bind(this)}
          />
          <Dropdown
            id="winner"
        ...
        <div className="submit">
          <Button.Group>
            <Button onClick={this.playerIncreament.bind(this)}>
              Add player
            </Button>
            <Button.Or />
            <Button positive onClick={this.confirm.bind(this)}>
              Save
            </Button>
            {this.state.error ? (
